class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "i32[4]", arg1_1: "i32[128]"):
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/_dynamo/_trace_wrapped_higher_order_op.py:158 in __torch_function__, code: return func(*args, **(kwargs or {}))
        view: "i64[4, 1]" = torch.ops.aten.reshape.default(iota_2, [4, 1])
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/_dynamo/_trace_wrapped_higher_order_op.py:158 in __torch_function__, code: return func(*args, **(kwargs or {}))
        view_2: "i32[4, 1]" = torch.ops.aten.reshape.default(index_1, [4, 1]);  index_1 = None
        ...
        view_3: "b8[1, 1, 4, 4]" = torch.ops.aten.reshape.default(bitwise_and_1, [1, 1, 4, 4]);  bitwise_and_1 = None
        ...
        view_4: "b8[1, 1, 1, 128, 1, 128]" = torch.ops.aten.reshape.default(constant_pad_nd, [1, 1, 1, 128, 1, 128]);  constant_pad_nd = None
        ...
        lt: "b8[1, 1, 1, 1]" = torch.ops.aten.lt.Scalar(sum_1, 16384)
        ...
        sort = torch.ops.aten.sort.stable(convert_element_type_2, stable = True, descending = True)
        ...
        eq: "b8[1, 1, 1, 1]" = torch.ops.aten.eq.Scalar(sum_1, 16384);  sum_1 = None
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:426 in _dense_to_ordered, code: col_indices = torch.argsort(dense_mask, dim=-1, descending=True, stable=True)
        sort_1 = torch.ops.aten.sort.stable(convert_element_type_5, stable = True, descending = True)
        ...
        sum_2: "i64[1, 1, 1]" = torch.ops.aten.sum.dim_IntList(convert_element_type_2, [-1]);  convert_element_type_2 = None
        ...
        index_put: "i32[1, 1, 1, 2]" = torch.ops.aten.index_put_.default(full_default_1, [unsqueeze_6, unsqueeze_3, unsqueeze, where], full_default_3);  full_default_1 = unsqueeze_6 = unsqueeze_3 = unsqueeze = where = full_default_3 = None
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:426 in _dense_to_ordered, code: col_indices = torch.argsort(dense_mask, dim=-1, descending=True, stable=True)
        sort_2 = torch.ops.aten.sort.stable(permute_2, stable = True, descending = True)
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:425 in _dense_to_ordered, code: num_blocks_in_row = dense_mask.sum(dim=-1)
        sum_3: "i64[1, 1, 1]" = torch.ops.aten.sum.dim_IntList(convert_element_type_5, [-1]);  convert_element_type_5 = None
        ...
        index_put_1: "i32[1, 1, 1, 2]" = torch.ops.aten.index_put_.default(full_default_4, [unsqueeze_13, unsqueeze_10, unsqueeze_7, where_1], full_default_6);  full_default_4 = unsqueeze_13 = unsqueeze_10 = unsqueeze_7 = where_1 = full_default_6 = None
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:426 in _dense_to_ordered, code: col_indices = torch.argsort(dense_mask, dim=-1, descending=True, stable=True)
        sort_3 = torch.ops.aten.sort.stable(permute_4, stable = True, descending = True)
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:425 in _dense_to_ordered, code: num_blocks_in_row = dense_mask.sum(dim=-1)
        sum_5: "i64[1, 1, 1]" = torch.ops.aten.sum.dim_IntList(permute_4, [-1]);  permute_4 = None
        ...
        # File: /workspace/.venv-e0/lib/python3.12/site-packages/torch/nn/attention/flex_attention.py:425 in _dense_to_ordered, code: num_blocks_in_row = dense_mask.sum(dim=-1)
        sum_4: "i64[1, 1, 1]" = torch.ops.aten.sum.dim_IntList(permute_2, [-1]);  permute_2 = None
